...
class ViewProfile extends Component {
	...
	componentDidMount(){
        ...
        axios.post("/user/findapplicantdetail",this.state,{headers: {token: Cookies.get('token')}})
		.then(response => {
    ...
    render() {
        ...
        return (
            <div  >
                <NavBar/>
                <NavLink onClick={this.contact.bind(this)}  className="bt btn btn-primary" to={{pathname:"/contact",state:{userid:this.state.userid}}}>Contact</NavLink> 
